...
<body>
    <main>
        <h1>Join our minecraft world!</h1>
        <button onclick="copyDomain()">
            ...
            minecraft.cloudsnake.nl
        </button>
        <p>
            Experience new adventures on our server in vast worlds full of mystery and challenge. With <strong>exclusive
                events and a community of players</strong>, you'll never be short of fun and company. Join us and
            discover what's in store for you!
        </p>
    </main>
    <script>
        function copyDomain() {
            navigator.clipboard.writeText('minecraft.cloudsnake.nl');
            alert("Copied the text: minecraft.cloudsnake.nl");
        }
    </script>
</body>
